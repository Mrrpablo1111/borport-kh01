...
const Footer: React.FC = () => {
  return (
    <div
      className="relative flex flex-col lg:flex-row justify-between items-center p-6 lg:p-12 xl:p-20 bg-cover bg-center font-sans text-white h-auto min-h-[200px] lg:h-[400px] forum-font"
      style={{
    ...
    >
      ...
      <div className="relative flex flex-col items-center lg:items-start mb-6 lg:mb-0 z-10 text-center lg:text-left">
        ...
        <div className="space-y-2 text-xl">
          ...
          <p className="flex items-center justify-center lg:justify-start">
            ...
            Email:{" "}
            <a
              href="mailto:senghong168hengheng@gmail.com"
              className="text-blue-300 ml-1"
            >
              senghong168hengheng@gmail.com
            </a>
          </p>
          <p className="flex items-center justify-center lg:justify-start">
      ...
      <div className="relative flex flex-col items-center lg:items-start z-10 text-center lg:text-left">
        ...
        <div className="flex flex-wrap justify-center lg:justify-start space-x-4">
          ...
          />
          <img src="NGO.png" alt="NGO Logo" className="w-20 lg:w-28 mb-2" />
        </div>
      </div>
    </div>
  );
